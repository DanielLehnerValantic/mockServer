		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#comvalanticmockserver-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comvalanticmockserver-display": {
								"semanticObject": "comvalanticmockserver",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.valantic.mockserver",
									"url": sap.ui.require.toUrl("com/valantic/mockserver")
								}
							}
						}
					}
